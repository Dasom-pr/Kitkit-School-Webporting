...
export class MissingNumberEngine extends BaseEngine {
  ...
  private drawExplosion(egg: EggData, cx: number, cy: number, gs: number) {
    ...
    if (splitT > 0 && this.birdImage?.complete) {
    ...
    if (splitT > 0 && this.cloudImage?.complete && splitT < 0.6) {
